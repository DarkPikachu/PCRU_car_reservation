...
@section("scripts")
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 text-center"><h1></h1></div>
    </div>
    ...
    <script type="text/javascript">
        ...
        //eternicode-bootstrap-datepicker
        head.load("assets/vendor/x-editable/dist/inputs-ext/color/color.css",
                  "assets/vendor/x-editable/dist/inputs-ext/color/color.js");
    </script>
       <script>
