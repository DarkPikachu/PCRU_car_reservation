            ...
            return {
                ...
                eventSources: [{
                        events(start, end, timezone, callback) {
                            ...
                            //var date = new Date()
                            //console.log(window.moment().format("YYYY-MM-DD")); 
                            ...
                            var uri = 'api/task/monthly/'
                            if(this.$refs.calendar === undefined)
                                uri = uri + moment().format("YYYY-MM-DD")
                            else
                                uri = uri + this.$refs.calendar.$emit('getDate').format('YYYY-MM-DD')
